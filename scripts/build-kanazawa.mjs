import fs from 'fs';
const kept = JSON.parse(fs.readFileSync('data/_kz.json', 'utf8'));
...
const city = {
  city: 'Kanazawa', subtitle: '近江町市場 · ベジ・グルテンフリー', center: OMI,
  bounds: [[36.52, 136.60], [36.62, 136.72]], tz: 'Asia/Tokyo', places: built,
};
