...
const CEN = [
  ...
  [/銀座|Ginza|Higashi.?Ginza|Shintomicho|新富町|Hibiya|日比谷/, 35.6717, 139.7650],
  [/秋葉原/, 35.6984, 139.7731], [/御茶ノ水|御茶の水/, 35.6993, 139.7650], [/神保町/, 35.6957, 139.7576], [/神田/, 35.6918, 139.7710],
  [/上野|御徒町|湯島|アメ横|稲荷町|Inaricho/, 35.7080, 139.7745], [/合羽橋|田原町/, 35.7118, 139.7900], [/浅草/, 35.7118, 139.7967],
  ...
  [/渋谷/, 35.6595, 139.7005], [/原宿|神宮前|明治神宮前|Jingumae|Harajuku/, 35.6700, 139.7030], [/表参道|青山/, 35.6650, 139.7120], [/恵比寿/, 35.6470, 139.7100],
  ...
  [/新橋/, 35.6660, 139.7580], [/虎ノ門|Kamiyacho|神谷町/, 35.6670, 139.7490], [/目黒/, 35.6340, 139.7160],
];
...
function diet(cuisine, name) {
  ...
  // Explicit GF signal only. 十割/juwari soba is a false friend — 100%-buckwheat
  // noodles still carry wheat cross-contamination and wheat-soy-sauce tsuyu, so it
  // does NOT qualify as gluten-free; those fall through to udon_soba gf:'ask'.
  const isGF = /グルテンフリー|gluten.?free|小麦粉不使用|米粉|セリアック|celiac|コメ粉/i.test(s);
  let ct = 'other';
